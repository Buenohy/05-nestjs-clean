/*
  ...
  - You are about to drop the column `slig` on the `questions` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "questions_slig_key";

-- AlterTable
ALTER TABLE "questions" DROP COLUMN "slig",
